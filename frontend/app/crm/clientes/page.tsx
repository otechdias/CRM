...
try {
  ...
  const payload = {
    ...
    status_cliente:
      editando.status_cliente || "Ativo",
    tipo_cliente:
      editando.tipo_cliente || null,
    origem_cliente:
      editando.origem_cliente || null,
    data_conversao:
      editando.data_conversao || null,
    valor_medio:
      editando.valor_medio ?? null,
    ultimo_contato:
      editando.ultimo_contato || null,
    proximo_contato:
      editando.proximo_contato || null,
    motivo_inativacao:
      editando.motivo_inativacao || null,
    observacoes:
      editando.observacoes || null,
  };
...
const confirmado = window.confirm(
  `Tem certeza que deseja excluir o cliente "${cliente?.nome_empresa || id}"?\n\nEssa ação não poderá ser desfeita.`
);
  ...
  <div className="p-6">
    ...
    <div className="mb-6">
      ...
      <p className="text-base-content/60 mt-1">
        Gerencie seus clientes, informações comerciais
        e acompanhamento.
      </p>
    </div>
